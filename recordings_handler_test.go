...
func TestRecordingsHandler_WithExistingReleaseId(t *testing.T) {
	recorder := newTestRequest("GET", "/releases/79215cdf-4764-4dee-b0b9-fec1643df7c5/recordings.json")
...
func TestRecordingsHandler_WithExistingArtistIdAndReleaseId(t *testing.T) {
	recorder := newTestRequest("GET", "/artists/056e4f3e-d505-4dad-8ec1-d04f521cbb56/releases/79215cdf-4764-4dee-b0b9-fec1643df7c5/recordings.json")
	assert.Equal(t, 200, recorder.Code)
}
