...
func TestReleaseGroupHandler_WithExistingReleaseGroupId(t *testing.T) {
	recorder := newTestRequest("GET", "/release-groups/aa997ea0-2936-40bd-884d-3af8a0e064dc.json")
...
func TestReleaseGroupHandler_WithReleaseGroupIdNotFound(t *testing.T) {
	recorder := newTestRequest("GET", "/release-groups/00000000-0000-0000-0000-000000000000.json")
...
func TestReleaseGroupHandler_WithInvalidReleaseGroupId(t *testing.T) {
	recorder := newTestRequest("GET", "/release-groups/bad-uuid.json")
...
func TestReleaseGroupHandler_WithExistingArtistIdAndReleaseGroupId(t *testing.T) {
	recorder := newTestRequest("GET", "/artists/056e4f3e-d505-4dad-8ec1-d04f521cbb56/release-groups/aa997ea0-2936-40bd-884d-3af8a0e064dc.json")
...
func TestReleaseGroupHandler_WithExistingReleaseGroupIdAndWrongArtistId(t *testing.T) {
	...
	recorder := newTestRequest("GET", "/artists/eeb1195b-f213-4ce1-b28c-8565211f8e43/release-groups/aa997ea0-2936-40bd-884d-3af8a0e064dc.json")
...
func TestReleaseGroupHandler_WithExistingReleaseGroupIdAndNonExistingArtistId(t *testing.T) {
	recorder := newTestRequest("GET", "/artists/00000000-0000-0000-0000-000000000000/release-groups/aa997ea0-2936-40bd-884d-3af8a0e064dc.json")
