...
func TestReleaseGroupHandler_WithExistingArtistGidAndGid(t *testing.T) {
...
func TestReleaseGroupHandler_WithExistingGidAndWrongArtistGid(t *testing.T) {
...
func TestReleaseGroupHandler_WithExistingGidAndNonExistingArtistGid(t *testing.T) {
